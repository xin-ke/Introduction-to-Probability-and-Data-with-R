...
ins_violin <- ins_violin +
  geom_violin(aes(alpha = .7, color = "#00bfc4"))

ins_hlth_violin <- ins_violin + 
  geom_violin(aes(x = checkup_recently, alpha = .3, color = "#f8766d"))
...
plot_usmap(data = avg_phys_hlth, values = "mean(physhlth)") +
  scale_fill_continuous(low = "white", high = "red", name = "Average Number of Poor Physical Health Days") +
